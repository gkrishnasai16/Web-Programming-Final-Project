<?php
    ...
    $username = "kgandi1"; // change to panther id if using codd
    $password = "kgandi1"; // change to panther id if using codd
    $dbname = "kgandi1"; // change to panther id if using codd
